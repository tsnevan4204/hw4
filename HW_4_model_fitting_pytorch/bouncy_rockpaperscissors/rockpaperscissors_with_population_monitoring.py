...
class BouncyImage:
    ...
    def __init__(self, initx, inity, canvas, hand_type):
        ...
        self.rockImage = tk.PhotoImage(file='bouncy_rockpaperscissors/rock.png').subsample(3,3)  
        self.paperImage = tk.PhotoImage(file='bouncy_rockpaperscissors/paper.png').subsample(3,3)
        self.scissorsImage = tk.PhotoImage(file='bouncy_rockpaperscissors/scissors.png').subsample(3,3)
...
class AnimationApp:
    ...
    def animate(self):
        ...
        # save data as pickle
        if self.Nsteps > 5000:
            with open('/Users/tsnevan/Desktop/HW_4_model_fitting_pytorch/datasets/dataset_09.pkl', 'wb') as filename:
                pickle.dump(self.pop_list, filename)
